...
define("ember-recipe-app/templates/recipe", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "TVOuL2ig", "block": "{\"statements\":[[\"text\",\"  \"],[\"open-element\",\"div\",[]],[\"flush-element\"],[\"append\",[\"unknown\",[\"recipe\",\"title\"]],false],[\"close-element\"],[\"text\",\"\\n    \"],[\"append\",[\"helper\",[\"recipe-detail\"],null,[[\"updateRecipe\",\"reset\",\"recipe\"],[\"save\",\"reset\",[\"get\",[\"model\"]]]]],false],[\"text\",\"\\n\"],[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "ember-recipe-app/templates/recipe.hbs" } });
});
define("ember-recipe-app/templates/recipe/edit", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "XRb4nYeX", "block": "{\"statements\":[[\"append\",[\"helper\",[\"edit-recipe\"],null,[[\"recipe\",\"updateRecipe\",\"reset\"],[[\"get\",[\"model\"]],\"save\",\"reset\"]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "ember-recipe-app/templates/recipe/edit.hbs" } });
});
...
if (!runningTests) {
  require("ember-recipe-app/app")["default"].create({"name":"ember-recipe-app","version":"0.0.0+f736cd1a"});
}
